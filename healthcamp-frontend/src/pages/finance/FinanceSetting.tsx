...
//     const resp = await api.get(getAdminInfo, {
//       headers: {
//         Authorization: token,
//       },
//     });
...
//   return (
//     <Box>
//       <Paper radius="md" bg="#EDF2F6" w={150} h={122} withBorder>
//         <Dropzone
...
//     const token = await generateAcessToken();
//     try {
//       const resp = await api.patch(updateAdminInfo, data, {
//         headers: {
//           Authorization: token,
//         },
//       });
...
//     try {
//       const resp = await api.patch(updateAdminPassword, data, {
//         headers: {
//           Authorization: token,
//         },
//       });
